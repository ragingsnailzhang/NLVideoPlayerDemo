...
-(void)readyRecordVideo{
    [[NLVideoRecordManager shareVideoRecordManager] configVideoParamsWithVideoRatio:self.param.ratio Position:self.param.position maxRecordTime:self.param.maxTime Compression:self.param.isCompression PushVC:self.param.pushVC];
